...
static const char qt_meta_stringdata_CMakeSetupDialog[] = {
    "CMakeSetupDialog\0setBinaryDirectory(QString)\0"
    "dir\0\0setSourceDirectory(QString)\0"
    "initialize()\0doConfigure()\0doGenerate()\0"
    "doOpenProject()\0doInstallForCommandLine()\0"
    "doHelp()\0doAbout()\0doInterrupt()\0"
    ...
    "showProgress(QString,float)\0msg,percent\0"
    "setEnabledState(bool)\0setupFirstConfigure()\0"
    "bool\0updateGeneratorLabel(QString)\0"
    "gen\0setExitAfterGenerate(bool)\0"
    "addBinaryPath(QString)\0loadBuildPaths()\0"
    "QStringList\0saveBuildPaths(QStringList)\0"
    ...
    "showUserChanges()\0setSearchFilter(QString)\0"
    "str\0prepareConfigure()\0doConfigureInternal()\0"
    "doGenerateInternal()\0exitLoop(int)\0"
    "doOutputContextMenu(QPoint)\0pt\0"
    "doOutputFindDialog()\0doOutputFindNext(bool)\0"
    "directionForward\0doOutputFindNext()\0"
...
static const char qt_meta_stringdata_QCMakeThread[] = {
    "QCMakeThread\0cmakeInitialized()\0\0"
};
