...
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_dnn.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_gapi.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_highgui.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_ml.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_objdetect.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_photo.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_stitching.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_video.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_videoio.so.4.1.1
...
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_calib3d.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_features2d.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_flann.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_imgcodecs.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_imgproc.so.4.1.1
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: /usr/lib/aarch64-linux-gnu/libopencv_core.so.4.1.1
...
examples/tutorial_api_cpp/11_asynchronous_custom_input_multi_camera.bin: examples/tutorial_api_cpp/CMakeFiles/11_asynchronous_custom_input_multi_camera.bin.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/smartcam/Desktop/EE_code/multipurposecamera/EE_team/init_resources/openpose/openpose-1.7.0/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable 11_asynchronous_custom_input_multi_camera.bin"
	cd /home/smartcam/Desktop/EE_code/multipurposecamera/EE_team/init_resources/openpose/openpose-1.7.0/build/examples/tutorial_api_cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/11_asynchronous_custom_input_multi_camera.bin.dir/link.txt --verbose=$(VERBOSE)
...
examples/tutorial_api_cpp/CMakeFiles/11_asynchronous_custom_input_multi_camera.bin.dir/clean:
	cd /home/smartcam/Desktop/EE_code/multipurposecamera/EE_team/init_resources/openpose/openpose-1.7.0/build/examples/tutorial_api_cpp && $(CMAKE_COMMAND) -P CMakeFiles/11_asynchronous_custom_input_multi_camera.bin.dir/cmake_clean.cmake
